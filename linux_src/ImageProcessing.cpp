...
ImageProcessing::ImageProcessing(int cameraID, std::string name, FileWriter * filewriter, Regulator * regulator, Identifier identifier){
	ImageProcessing::cameraID = cameraID;
	ImageProcessing::name = name;
	ImageProcessing::filewriter = filewriter;
	ImageProcessing::regulator = regulator;
