...
Weighted_median_filter::Weighted_median_filter(Identifier axis,size_t size_x, size_t size_phi)
...
void Weighted_median_filter::update_pos(uint16_t pos_uint, double last_u,double state[4]){
    double average_x = 0;
    current_time_x = std::chrono::high_resolution_clock::now();
...
void Weighted_median_filter::update_angle(double phi, double last_u,double state[4]){
